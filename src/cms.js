...
function form(item={}){
  ...
  return `<form class="cms-form" data-cms-form>
    ...
    ${item.id?'':`<h3>Primary contact</h3>
    <div class="field-grid"><div class="field"><label>担当者</label><input name="contactNameLocal"></div><div class="field"><label>Contact</label><input name="contactNameEn"></div></div>
    <div class="field-grid"><div class="field"><label>所属（日本語）</label><input name="organizationLocal"></div><div class="field"><label>Organization</label><input name="organizationEn"></div></div>
    <div class="field-grid"><div class="field"><label>Email</label><input type="email" name="contactEmail"></div><div class="field"><label>Phone</label><input name="contactPhone"></div></div>`}
